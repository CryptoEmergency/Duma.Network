            ...
            <section class="card-project">
              ...
              <div class="about-project">
                ...
                <p class="text">
                  ...
                  pre-market entry via our platform. Make informed decisions by
                ...
                <button class="btn btn-gradient mt-10">
                  BECOME OUR INVESTOR
                </button>
              </div>
            </section>
                ...
                <div class="scheme-card">
                  ...
                  <div class="scheme-card_desc">
                    <p class="text">
                      ...
                      and the high cost of quality education.
                    </p>
                    <p class="text">
                      The second problem is that venture investing is not
                      accessible to most people and is often limited only to
                      public rounds.
                    </p>
                    <p class="text">
                      The third problem is that more investors want to exit SAFT
                      deals before TGE or before vesting ends. However, they
                      cannot do so because there are no automated mechanics and
                    ...
                    <div class="grid-2">
                      ...
                      <ul class="list-standart">
                        ...
                        <li>
                          ...
                          considered daily. In the future, public rounds and the
                          team's share will be reduced and adjusted to avoid
                          large token sales in the future
                        </li>
                        <li>
